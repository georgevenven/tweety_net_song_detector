...
trainer = Trainer(model=model, train_loader=train_loader, test_loader=test_loader, device=device, lr=config["lr"], plotting=True, batches_per_eval=25, desired_total_batches=200, patience=4)
trainer.train()
